...
The references in `study/notes/` are written from primary sources and are the
...
references into `study/docs/reference/` so MkDocs serves and indexes
them.
...
DEFAULT_SOURCE_DIR = REPO_ROOT / 'study' / 'notes'
DEFAULT_OUTPUT_DIR = REPO_ROOT / 'study' / 'docs'
REFERENCE_SUBDIR = 'reference'

SYNC_BANNER = (
    "<!-- Generated copy. Source: study/notes/{source}\n"
