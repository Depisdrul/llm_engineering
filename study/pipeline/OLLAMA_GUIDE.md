...
python study/pipeline/extract_all.py --use-llm --provider ollama --weeks 1,2,3
```
...
python study/pipeline/extract_all.py --use-llm --provider ollama --model llama3.2
```
...
python study/pipeline/extract_all.py --use-llm --provider ollama --weeks 1

# Compare with OpenAI (costs ~$0.50 for one week)
python study/pipeline/extract_all.py --use-llm --provider openai --weeks 1
```
...
python study/pipeline/extract_all.py --use-llm --provider ollama --model phi3
```
